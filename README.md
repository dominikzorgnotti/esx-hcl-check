...
| `-workers` | Maximum number of hosts to collect from in parallel. Use `1` to force fully sequential collection in constrained or rate-sensitive environments. | `8` |
